...
//    );
    ...
    public List<CampfireFuels> campfireFuels = List.of(
            new CampfireFuels("#minecraft:logs", 1600),
            new CampfireFuels("#minecraft:planks", 400),
            new CampfireFuels("minecraft:stick", 200),
            new CampfireFuels("minecraft:coal", 2400),
            new CampfireFuels("minecraft:charcoal", 2400),
            new CampfireFuels("minecraft:coal_block", 19200)
    );
